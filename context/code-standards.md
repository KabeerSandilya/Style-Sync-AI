...
* Keep modules small, single-purpose, and domain-driven (wardrobe, AI, weather, auth).
...
* Add `"use client"` only for browser interactivity, animations, or drag-and-drop.
...
* All external APIs (weather, AI models) must be wrapped behind service abstractions.
