...
export async function getMostWornGarments(userId: string, limit: number = 10): Promise<GarmentWithStats[]> {
  ...
  // Sort by wearCount descending, then by lastWornAt descending (most recently worn first)
